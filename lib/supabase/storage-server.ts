...
/**
 * Server-side storage utilities for Supabase Storage
 * Use these functions in server actions, API routes, and server components
 */
...
/**
 * Get signed URL for a file in private buckets (Server-side)
 *
 * @param bucket - Storage bucket name
 * @param path - File path within the bucket
...
/**
 * List files in a storage path (Server-side)
 *
 * @param bucket - Storage bucket name
