...
/**
 * Client-side storage utilities for Supabase Storage
...
/**
 * Get public URL for a file in Supabase Storage (Client-side)
 *
 * @param bucket - Storage bucket name
 * @param path - File path within the bucket
...
/**
 * Get signed URL for a file in private buckets (Client-side)
 *
 * @param bucket - Storage bucket name
 * @param path - File path within the bucket
...
/**
 * List files in a storage path (Client-side)
 *
 * @param bucket - Storage bucket name
